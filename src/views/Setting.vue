...
export default {
  ...
  components: {Loading, PageHeader, Multiselect},
  computed: {
  ...
  methods: {
    ...
    submitMailChimp() {
      ...
      this.upMailChimp(data)
        .then(() => {})
        .catch(() => {this.originMailChimp = true});
    },
    restoreMailChimp() {
      ...
      <div class="col-xl-24 pa-0">
        <div class="card">
          <div class="card-body" style="border: 0px">
            <div class="row">
              <div class="col-xl-12 pt-0">
                <label>SURVEY MEAL PLAN</label><div class="input-group">
                <button
                  class="btn btn-warning"
                  type="button"
