...
export default {
  page: {
    title: "category of ingredients",
    meta: [
      {
        name: "category of ingredients",
  ...
  computed: {
    ...mapState('ingredientsCategory', ['totalItems', 'totalPages', 'itemsInPage']),
  },
  created() {
    this.loading = true
  ...
  methods: {
    ...mapActions('ingredientsCategory', [
      'getInitList',
      'getListItem',
      'updateItem',
      'deleteById',
        ...
        <div class="card">
          <div class="card-body">
            ...
            <DialogDelete
              ...
              title="Delete category of ingredients"
