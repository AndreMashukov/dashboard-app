...
export default {
  page: {
    title: "Category of recipes",
    meta: [
      {
        name: "Category of recipes",
  ...
  computed: {
    ...mapState('recipesCategory', ['totalItems', 'totalPages', 'itemsInPage']),
  },
  created() {
    this.loading = true
        ...
        <div class="card">
          <div class="card-body">
            ...
            <DialogDelete
              ...
              title="Delete category of recipes"
