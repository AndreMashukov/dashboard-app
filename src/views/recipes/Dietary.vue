...
export default {
  page: {
    title: "Dietary of recipes",
    meta: [
      {
        name: "Dietary of recipes",
  ...
  computed: {
    ...mapState('recipesDietary', ['totalItems', 'totalPages', 'itemsInPage']),
  },
  created() {
    this.loading = true
        ...
        <div class="card">
          <div class="card-body">
            ...
            <DialogDelete
              ...
              title="Delete dietary of recipes"
