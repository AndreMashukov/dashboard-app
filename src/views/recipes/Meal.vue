...
import FormRecipeMeal from "@/components/form/FormRecipeMeal";
...
export default {
  page: {
    title: "Meal of recipes",
    meta: [
      {
        name: "Meal of recipes",
        content: "appConfig.description",
      },
    ],
  },
  components: {DialogDelete, Loading, PageHeader, FormRecipeMeal},
  computed: {
    ...mapState('recipesMeal', ['totalItems', 'totalPages', 'itemsInPage']),
  },
  created() {
    this.loading = true
...
<!--                  <th>Be duplication</th>-->
                ...
                <tr v-for="item in itemsInPage" :key="item._id">
                  <td>{{ item.name }}</td>
<!--                  <td>{{ item.beDuplicated }}</td>-->
                  <td>{{ item.isMenuFood }}</td>
