...
import FormMediaTags from "@/components/form/FormMediaTags";
...
export default {
  ...
  components: {DialogDelete, Loading, PageHeader, FormMediaTags},
  computed: {
    ...mapState('mediaTags', ['totalItems', 'totalPages', 'itemsInPage']),
    ...mapState('medias', ['mediaCategory', 'mediaTopics']),
  },
  created() {
    this.loading = true
    Promise.all([
        ...
        <div class="card">
          <div class="card-body">
            ...
            <form-media-tags
              ...
              :listCategory="this.mediaCategory"
              :listTopic="this.mediaTopics"
              title="tags"
            ...
            <div class="table-responsive" style="padding-left: 10px">
              <table class="table table-centered table-nowrap align-middle">
                ...
                <tr v-for="item in itemsInPage" :key="item._id">
                  ...
                  <td>{{ item.topic ? item.topic.name : null }}</td>
