...
import FormMediaTopic from "@/components/form/FormMediaTopic";
...
export default {
  ...
  components: {DialogDelete, Loading, PageHeader, FormMediaTopic},
  computed: {
    ...mapState('mediaTopic', ['totalItems', 'totalPages', 'itemsInPage', 'listCategory']),
  },
  created() {
    this.loading = true
