...
import FormMediaCategory from "@/components/form/FormMediaCategory";
...
export default {
  page: {
    title: "Category of media",
    meta: [
      {
        name: "Category of media",
        content: "appConfig.description",
      },
    ],
  },
  components: {DialogDelete, Loading, PageHeader, FormMediaCategory},
  computed: {
    ...mapState('mediaCategory', ['totalItems', 'totalPages', 'itemsInPage']),
  },
  created() {
    this.loading = true
        ...
        <div class="card">
          <div class="card-body">
            ...
            <DialogDelete
              ...
              title="Delete category of media"
